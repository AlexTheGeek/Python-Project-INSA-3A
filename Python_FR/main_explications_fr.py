...
print(dataset.describe())               #Affichage des statistiques (les quartiles 1, 2 et 3) pour chaque type de valeurs du DataFrame
...
seabornInstance.distplot(dataset['Temp_Max'])   #Permet de dessiner un trace de distribution sur une FacetGrid, permettant de visualiser les donnees de DataFrame des Temp_Max dans un format d'histogramme (par defaut)
plt.show()                                      #Affichage du graphique/figure
...
print(reg.coef_)                                                                                    #Affichage du coefficient directeur de la droite de regression
y_pred = reg.predict(X_test)                                                                        #Utilisation des donnees de test pour faire des predictions sur le Temp_Max
...
#
###
df1 = df.head(25)                                                       #Recuperation des 25 premières lignes de df pour les mettre dans df1
...
print(np.std(dataset['Temp_Min']))                  #Affiche l'ecart-type des valeurs du tableau dataset['Temp_Min']

###
#Creation d'un histogramme en escalier
###
plt.figure(1)                                   #Creation d'un figure avec un unique identifiant egale à 1
plt.hist(Means, bins=10, histtype='step')  #Creation d'un histogramme en escalier avec un seul trait et sans remplissage, avec 10 marches ayant la meme largeur
plt.show()                                      #Affichage du graphique/figure
...
###
stats.probplot(Means, plot=plt) #Calcule les quantiles de la courbe de probabilite normale de Means et la trace avec pylab
plt.show()                      #Affichage du graphique/figure
